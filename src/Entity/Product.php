...
class Product
{
    ...
    #[ORM\Column(type: Types::TEXT, nullable: true)]
    private ?string $additionnal_infos = null;
    ...
    {
        return $this->additionnal_infos;
    }

    public function setAdditionnalInfos(?string $additionnal_infos): static
    {
        $this->additionnal_infos = $additionnal_infos;
